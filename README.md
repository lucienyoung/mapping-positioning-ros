...
This is the mapping and relocalizing modules of CityU Hk's blind navigation system. However, the proposed system consists of a Galaxy A54 Android smartphone as a user interface, a Dell personal computer with i5-Core CPU (which can be replaced by Jestson development board for edge computing) and 8GB RAM as the main processor, and a head-mounted RealSense D455 RGB-D camera to perceive the environment. Detailed codes in different module can be seen from the following links we provide, i.e, the [blind-navigation-app](https://github.com/lucienyoung/blind-navigation-app.git) can be found here.
